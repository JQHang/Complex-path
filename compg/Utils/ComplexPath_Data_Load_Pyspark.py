...
def All_ComplexPath_Data_Load(Spark_Session, Aim_UID_info_dict, Feature_Data_From_Online_Config_dict, Data_Store_dir,
    ...
    Aim_Node_type = Aim_UID_info_dict['Node_Types'][0]
    ...
    tmp_Aim_Feature_Table_dt_list = Aim_UID_info_dict['Feature_Times']
    ...
    Complex_Path_Pyspark_Data_Dict['Raw_Feature'] = {}
    Complex_Path_Pyspark_Data_Dict['Raw_Feature']['data'] = tmp_aim_node_agg_feature_rdd
    Complex_Path_Pyspark_Data_Dict['Raw_Feature']['feature_comments'] = feature_columns_comment
    ###########################################################################################################################
    print('----------------------------------------------------------------------------')
    print('Process the following complex-paths:', tmp_complex_path_name_list)

    Complex_Path_Pyspark_Data_Dict['Complex_Paths'] = {}
    ...
    for tmp_complex_path_name in tmp_complex_path_name_list:
        ...
        Complex_Path_Pyspark_Data_Dict['Complex_Paths'][tmp_complex_path_name] = {}
        Complex_Path_Pyspark_Data_Dict['Complex_Paths'][tmp_complex_path_name]['data'] = []
        Complex_Path_Pyspark_Data_Dict['Complex_Paths'][tmp_complex_path_name]['node_type'] = []
        Complex_Path_Pyspark_Data_Dict['Complex_Paths'][tmp_complex_path_name]['feature_comments'] = []
        ...
        for tmp_column_i in range(len(tmp_meta_path_info)):
            ...
            Complex_Path_Pyspark_Data_Dict['Complex_Paths'][tmp_complex_path_name]['data'].append(tmp_aim_node_agg_feature_rdd)
            Complex_Path_Pyspark_Data_Dict['Complex_Paths'][tmp_complex_path_name]['node_type'].append(tmp_column_node_class)
            Complex_Path_Pyspark_Data_Dict['Complex_Paths'][tmp_complex_path_name]['feature_comments'].append(feature_columns_comment)
